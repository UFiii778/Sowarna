...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white font-sans relative overflow-hidden flex flex-col justify-between transition-colors duration-300">
      ...
      <header className="w-full max-w-6xl mx-auto px-6 py-5 flex justify-between items-center border-b border-slate-200 dark:border-white/5 relative z-10">
        <div className="flex items-center gap-2">
          <span className="text-xl font-black tracking-tighter bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 dark:from-cyan-400 dark:via-blue-400 dark:to-white bg-clip-text text-transparent">
            SOWAN<span className="text-slate-900 dark:text-white">QR</span>
          </span>
          <span className="px-2 py-0.5 text-[10px] font-bold bg-slate-200 dark:bg-white/10 rounded-full border border-slate-300 dark:border-white/10 tracking-widest text-slate-700 dark:text-white">V2.0</span>
        </div>
        <div className="flex gap-3">
          <button
            type="button"
            onClick={() => setLang(lang === 'id' ? 'en' : 'id')}
            className={`px-3 py-1.5 text-xs font-bold border rounded-xl transition uppercase tracking-wider ${isDarkMode
              ? 'border-white/10 bg-white/5 hover:bg-white/10 text-slate-300'
              : 'border-sky-200 bg-white hover:bg-sky-100 text-sky-900 shadow-sm'
              }`}
          >
            {lang === 'id' ? 'EN' : 'ID'}
          </button>
      ...
      <section className="flex-1 flex items-center justify-center p-6 relative z-10 w-full max-w-lg mx-auto">
        <div className="w-full bg-white/40 dark:bg-slate-900/40 border border-slate-200/60 dark:border-white/10 backdrop-blur-2xl rounded-3xl p-8 shadow-[0_24px_70px_rgba(0,0,0,0.15)] dark:shadow-[0_24px_80px_rgba(0,0,0,0.6)] transition-all duration-300">

          {!result ? (
            <div>
              <div className="flex border border-slate-200 dark:border-white/5 bg-white/60 dark:bg-slate-900 p-1 rounded-2xl mb-6 shadow-inner">
                <button
                  type="button"
                  onClick={() => { setAuthMode('login'); setIsVerified(false); }}
                  className={`flex-1 py-3 rounded-xl text-xs font-black tracking-wider uppercase transition-all ${authMode === 'login' ? 'bg-gradient-to-r from-cyan-500 to-indigo-500 text-white shadow-lg shadow-indigo-500/20' : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'}`}
                >
                  Login
                </button>
                <button
                  ...
                  className={`flex-1 py-3 rounded-xl text-xs font-black tracking-wider uppercase transition-all ${authMode === 'register' ? 'bg-gradient-to-r from-cyan-500 to-indigo-500 text-white shadow-lg shadow-indigo-500/20' : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'}`}
                >
                  {t.tabNew}
                </button>
              </div>
              ...
              <div className="text-center mb-6">
                <h3 className="text-sm font-bold tracking-wider text-cyan-600 dark:text-blue-400 uppercase">
              ...
              {authMode === 'login' ? (
                <form onSubmit={handleLogin} className="space-y-4 animate-in fade-in duration-300">
                  <div>
                    <label className="text-xs font-bold text-slate-500 dark:text-slate-400 block mb-1">{t.labelEmail}</label>
                    <input
                      type="email"
                      required
                      ...
                      className="w-full p-3 bg-white/70 dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white outline-none focus:border-cyan-500 dark:focus:border-cyan-400 transition text-sm shadow-inner"
                    />
                  </div>

                  <div>
                    <label className="text-xs font-bold text-slate-500 dark:text-slate-400 block mb-1">{t.labelWa}</label>
                    <input
                      type="text"
                      required
                  ...
                  <div className="space-y-2 pt-2 border-t border-slate-200 dark:border-white/5">
                    <label className="text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider block uppercase">{t.metodeOTP}</label>
                    <div className="flex gap-3">
                      <label className={`flex-1 flex items-center justify-center gap-2 p-3 rounded-xl border text-xs font-bold cursor-pointer transition ${otpMethod === 'whatsapp'
                        ...
                        : 'border-slate-200 dark:border-white/5 bg-white/30 dark:bg-white/[0.02] text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5'
                        }`}>
                        <input
                          type="radio"
                ...
                <div className="w-full animate-in fade-in duration-300 text-left block relative">
                  <Stepper
                    ...
                    errorSteps={errorSteps} // Mengirim daftar step merah ke komponen internal
                    onStepChange={(step) => {
                      setActiveStep(step);
                  ...
                  >
                    ...
                    <Step>
                      <div className="w-full space-y-4 py-2 block relative">
                        ...
                        <div>
                          <label className="text-xs font-bold text-slate-500 dark:text-slate-400 block mb-1">{t.labelNik}</label>
                          <input
                            type="text"
                            required
                        ...
                        <div>
                          <label className="text-xs font-bold text-slate-500 dark:text-slate-400 block mb-1">{t.labelNama}</label>
                          <input
                            type="text"
                            required
                        ...
                        <div>
                          <label className="text-xs font-bold text-slate-500 dark:text-slate-400 block mb-1">{t.labelInstansi}</label>
                          <input
                            type="text"
                            required
                    ...
                    <Step>
                      <div className="w-full space-y-4 py-2 block relative">
                        ...
                        <div>
                          <label className="text-xs font-bold text-slate-500 dark:text-slate-400 block mb-1">Nomor WhatsApp</label>
                          <input
                            type="text"
                            required
                        ...
                        <div>
                          <label className="text-xs font-bold text-slate-500 dark:text-slate-400 block mb-1">Alamat Email</label>
                          <input
                            type="email"
                            required
                        ...
                        <div className="space-y-2 pt-2 border-t border-slate-200 dark:border-white/5">
                          <label className="text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider block uppercase">Kanal Pengiriman OTP</label>
                          <div className="flex gap-3">
                            <label className={`flex-1 flex items-center justify-center gap-2 p-3 rounded-xl border text-xs font-bold cursor-pointer transition ${otpMethod === 'whatsapp'
                              ? 'border-cyan-500/50 bg-cyan-500/10 text-cyan-600 dark:text-cyan-400'
                              : 'border-slate-200 dark:border-white/5 bg-white/30 dark:bg-white/[0.02] text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5'
                    ...
                    <Step>
                      <div className="w-full space-y-4 py-2 block relative">
                        ...
                        <div>
                          <label className="text-xs font-bold text-slate-500 dark:text-slate-400 block mb-1">Pegawai yang Menemui</label>
                          <input
                            type="text"
                            required
                        ...
                        <div>
                          <label className="text-xs font-bold text-slate-500 dark:text-slate-400 block mb-1">Keperluan / Tujuan</label>
                          <textarea
                            required
                            rows={3}
                            ...
                            className="w-full p-3 bg-white/70 dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white outline-none focus:border-cyan-500 dark:focus:border-cyan-400 transition text-sm shadow-inner resize-none"
                          />
                        </div>
                      </div>
                    </Step>
                    ...
                    <Step>
                      <div className="w-full space-y-4 py-2 block relative">
                        ...
                        <div className="space-y-2.5 bg-slate-100/60 dark:bg-slate-900/40 border border-slate-200/60 dark:border-white/5 rounded-2xl p-3.5 shadow-inner text-left text-xs">
                          ...
                          <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/5 pb-2">
                            <div>
                              ...
                              <p className="font-semibold text-slate-800 dark:text-slate-200">{form.nama || '-'} ({form.instansi || '-'})</p>
                          ...
                          <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/5 pb-2">
                            <div>
                              ...
                              <p className="font-semibold text-slate-800 dark:text-slate-200">WA: {form.whatsapp || '-'} | Email: {form.email || '-'}</p>
                          ...
                          <div className="flex items-center justify-between pb-1">
                            <div>
                              ...
                              <p className="font-semibold text-slate-800 dark:text-slate-200">Menemui: {form.menemui || '-'} <span className="text-slate-400 font-normal">| Keperluan:</span> {form.keperluan || '-'}</p>
                            </div>
                            <button
                              type="button"
                        ...
                        <div className="space-y-2 text-left">
                          <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase">{t.labelTtd}</label>
                          <div className="border border-slate-300 dark:border-white/10 bg-white rounded-2xl overflow-hidden shadow-inner">
                            <SignatureCanvas
                              ref={sigCanvas}
                              penColor="black"
                              canvasProps={{ className: 'w-full h-28 cursor-crosshair' }}
                              onEnd={() => setHasSigned(true)} // 🔥 Mengunci status bahwa tanda tangan sudah terisi
                            />
                          </div>
                          <button
                            type="button"
                            onClick={() => {
                              ...
                              setHasSigned(false); // 🔥 Reset status jika dihapus
                            }}
                            className="text-[10px] font-bold text-slate-500 dark:text-slate-400 hover:text-rose-500 transition uppercase tracking-widest flex items-center gap-1"
                          >
                            ✕ {t.btnClearTtd}
                          </button>
                        </div>
            ...
            <div className="text-center space-y-6 py-4 animate-in fade-in zoom-in-95 duration-300">
              <div className="w-16 h-16 bg-emerald-500/10 text-emerald-500 dark:text-emerald-400 border border-emerald-500/20 rounded-full flex items-center justify-center mx-auto text-2xl font-bold animate-pulse">
                <UserCheck className='w-10 h-5'></UserCheck>
              </div>
              <div>
                <h3 className="text-xl font-black uppercase text-slate-900 dark:text-white tracking-wide">{t.ticketSuccess}</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">{t.ticketDesc}</p>
              </div>

              <div className="relative bg-white p-5 rounded-2xl border-4 border-slate-200 dark:border-slate-900 inline-block shadow-2xl">
      ...
      {isOtpModalOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-950/60 dark:bg-slate-950/80 backdrop-blur-md p-4 animate-in fade-in duration-200">
          <div className="w-full max-w-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-3xl p-6 text-center shadow-2xl transform scale-100 animate-in zoom-in-95 duration-200">
            ...
            <p className={`text-xs mt-1 leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-sky-800/80'}`}>
              {t.digitotp} <span className={`font-bold ${isDarkMode ? 'text-white' : 'text-sky-950'}`}>{otpMethod === 'whatsapp' ? 'WhatsApp' : 'Email'}</span>
            </p>
            ...
            <input
              ...
              className="w-full text-center text-2xl font-mono tracking-[1em] pl-[1em] py-3 mt-5 bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-white/10 rounded-xl text-cyan-600 dark:text-cyan-400 outline-none focus:border-cyan-500 transition"
            />

            {otpError && (
              <p className="text-[11px] font-bold text-rose-600 dark:text-rose-400 bg-rose-500/10 py-1.5 px-3 rounded-lg mt-3 text-left">
                ⚠ {otpError}
              </p>
            )}
            ...
            <div className="mt-5 text-xs font-semibold">
              {countdown > 0 ? (
                <p className="text-slate-400 dark:text-slate-500">{t.resendotp} <span className="text-cyan-500 dark:text-cyan-400 font-bold">{countdown}s</span></p>
              ) : (
                <button
                  type="button"
                  onClick={handleResendOtp}
                  className="text-cyan-600 dark:text-cyan-400 hover:opacity-80 underline font-bold transition block mx-auto cursor-pointer"
                >
                  {t.cannototp}
                </button>
              )}
            ...
            <div className="flex gap-3 mt-5">
              <button
                ...
                className="flex-1 py-3 text-xs font-bold rounded-xl border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-white/10 transition uppercase"
              >
                {t.cancel}
              </button>
              <button
      ...
      {showAnimation && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-950/80 backdrop-blur-sm transition-all duration-300">
          <div className={`p-8 rounded-3xl bg-white dark:bg-slate-900 border text-center shadow-2xl max-w-xs w-full mx-4 transform scale-100 transition-all duration-300 animate-in fade-in zoom-in-95 ${animationType === 'success' ? 'border-emerald-500/30 shadow-emerald-500/10' : 'border-rose-500/30 shadow-rose-500/10'
            }`}>
            <div className={`w-20 h-20 mx-auto rounded-full flex items-center justify-center mb-5 text-4xl font-extrabold ${animationType === 'success' ? 'bg-emerald-500/10 text-emerald-500 dark:text-emerald-400' : 'bg-rose-50/10 text-rose-500 dark:text-rose-400'
              }`}>
              {animationType === 'success' ? <UserCheck2 className='w-10 h-10'></UserCheck2> : <AlertCircle className='w-10 h-10'></AlertCircle>}
            </div>
            <h3 className={`text-xl font-black tracking-wide ${animationType === 'success' ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'
              }`}>
            ...
            {animationType === 'error' && (
              <div className="flex gap-2 mt-5">
                <button
                  ...
                  onClick={() => {
                    setShowAnimation(false);
                    // Langsung lompat ke step yang bermasalah (Step 2)
                    setActiveStep(2);
                  }}
                  className="flex-1 py-2.5 bg-slate-100 dark:bg-white/10 text-slate-700 dark:text-slate-200 text-xs font-black rounded-xl uppercase tracking-widest transition hover:bg-slate-200"
                >
                  Kembali
                </button>
              </div>
      ...
      <footer className="w-full text-center py-4 text-[10px] font-bold text-slate-500 dark:text-slate-500 uppercase tracking-widest relative z-10 border-t border-slate-200 dark:border-white/5 bg-white/40 dark:bg-slate-950/40 backdrop-blur-md transition-all duration-300">
